...
train_directory = './datasets/eyepac-light-v2-512-jpg/train'
valid_directory = './datasets/eyepac-light-v2-512-jpg/val'
# Set the model save path
PATH="model_train2_1.pth" 
...
if train_mode=='finetune':
    ...
    checkpoints = './checkpoints/resnet50_512_ImageNet+Fundus.pth'
    model_ft = models.resnet50(pretrained=checkpoints)
