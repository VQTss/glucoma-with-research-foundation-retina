...
DATA_DIR = './datasets/new_data' # to run with the sample dataset, just set to 'hymenoptera_data'
...
f1 = F1Score(task="binary", num_classes=NUM_CLASSES, average='macro')
...
# Save model
torch.save(model_ft.state_dict(), 'fine_tuned_best_model_1.pt')
